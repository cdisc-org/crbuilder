...
#   04/24/2023 (htu) - initial coding based on get_doc_stats
#
import os
import re
import json 
...
def get_all_docs(db: str = 'library', 
    ...
    df_log = pd.DataFrame(columns=["rule_id", "core_id",  
                                   ...
                                   "rule_cnt", "rule_ids",
                                   "doc_cnt", "dup_ids",
                                   "Error Message","Description","Organization","Standard Name",
                                   "Standard Version", "Executability","Sensitivity"])   
    v_stp = 4.1
    ...
    for i in doc_list:
        ...
        df_row = {"rule_id": None, "core_id": None, "combined_id": None,
                  ...
                  "Error Message": None, "Description":None, 
                  "Organization":None, "Standard Name":None,
                  "Standard Version":None, "Executability":None, 
                  "Sensitivity":None}
        rule_id = None
...
if __name__ == "__main__":
    ...
    v_prg = __name__ + "::get_all_docs"
    # get_doc_stats(ct="editor_rules_dev_20230411",wrt2file=1)
    get_all_docs(ct="editor_rules_dev",wrt2file=1)
